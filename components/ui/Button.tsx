...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles = `
    ...
    focus:outline-none focus:ring-2 focus:ring-accent-cyan focus:ring-offset-2 focus:ring-offset-brutal-black
  `;
  ...
  const variants = {
    primary: `
      ...
      px-8 py-4
      hover:bg-brutal-cream hover:text-brutal-black hover:border-brutal-cream
      hover:shadow-brutal-cyan hover:-translate-x-1 hover:-translate-y-1
      active:translate-x-0 active:translate-y-0 active:shadow-none
      disabled:bg-brutal-ink disabled:text-brutal-stone disabled:border-brutal-ink
      disabled:cursor-not-allowed disabled:hover:translate-x-0 disabled:hover:translate-y-0 disabled:hover:shadow-none
    `,
    secondary: `
      bg-transparent text-brutal-cream border-brutal-cream
      px-8 py-4
      hover:bg-brutal-cream hover:text-brutal-black
      hover:shadow-brutal-cyan hover:-translate-x-1 hover:-translate-y-1
      active:translate-x-0 active:translate-y-0 active:shadow-none
    `,
    text: `
      bg-transparent text-brutal-cream border-transparent
      px-4 py-2
