...
export default function NotFound() {
  return (
    <div className="bg-brutal-cream dark:bg-brutal-black min-h-[80vh] flex items-center justify-center relative overflow-hidden">
      ...
      <div className="container-brutal text-center relative z-10">
        ...
        <div className="relative mb-8">
          <span className="font-display text-[12rem] md:text-[16rem] text-brutal-stone/20 dark:text-brutal-ink leading-none">
            404
          </span>
        ...
        <h1 className="text-4xl text-brutal-black dark:text-brutal-cream mb-4">Page Not Found</h1>
