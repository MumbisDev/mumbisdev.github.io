  ...
  return (
    <div className="w-full">
      ...
      <textarea
        ...
        } px-4 py-3 text-sm text-black placeholder-neutral-400 focus:outline-none focus:border-black focus:ring-2 focus:ring-black focus:ring-opacity-10 resize-none ${className}`}
        {...props}
      />
      {error && (
